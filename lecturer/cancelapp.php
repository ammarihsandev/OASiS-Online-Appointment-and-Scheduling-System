...
$Lecturer_ID=$_SESSION['myuser'];
	...
	$resource3=mysql_query($query3,$link) or die ("An unexpected error occured while <b>updating</b> the record, Please try again!");
...
You are going to cancel the appointment with your student.
<table>
<tr><td>Student Name </td><td><b>".$result2[2]."&nbsp;".$result2[3]."</b></td></tr>
...
<form action=\"cancelapp_exec.php\" method=\"post\" name=\"cancelappointment\">
 ...
 <input type=\"hidden\" name=\"Student_email\" value=\"".$result2[5]."\">
 <input type=\"hidden\" name=\"studentname\" value=\"".$result2[2]."$nbsp;".$result2[3]."\">
 <input type=\"hidden\" name=\"lecturername\" value=\"".$result3[2]."$nbsp;".$result3[3]."\">
