...
if ($nw == 1)
	{
		echo "<br/><br/><center><a href=\"?nw=0\">PRE</a>&nbsp;&nbsp;&nbsp;<a href=\"?nw=2\">NEXT </a></center><center><table border=\"1\"><tr><td> <table border=\"0\"><tr>";
		for ($i = 7; $i < 12; $i++) 
		{
		echo "<td><center><small><b>".date("l <\b\\r> m/d/y", $ts + $i * 86400) . "</b></small></center></td>";
		}
		echo "</tr><tr>";
		...
		if ($dayList == $dayDB) 
		{
		echo "<td><center><small><a href=\"confirm.php?Lecturer_ID=".$Lecturer_ID."&time=".$row2['time']."&day=".$dayList."\">".date('h:i A', strtotime($row2['time']))."</small></center></td>"; }
		else
		{
		echo "<td></td>"; }		}		
		echo "</tr>"; }
...
echo"<table><tr><td>".$row['day']."</td><td>".$row['time']."</td></tr></table>";
