...
$dateo = substr($row['Message_time'], 0, 10); 
 $username_array[] = "<tr><td><center>".$status."</center></td><td>".substr($name, 0, 20)."</td><td>".substr($row['Message_content'], 0, 50)."</td><td><center>".$dateo."</center></td><td><center>
	<a href=\"viewmessage.php?Message_ID=".$row['Message_ID']."&Lecturer_ID=".$row['Lecturer_ID']."\"><img title=\"View Message\" width=\"24\" height=\"24\"  border=\"0\" src=\"../image/viewmessage.png\"/></a>	
	</center></td></tr>";
}
}
...
$content="
<div  align=\"right\"><a href=\"message2.php\"><img  border=\"0\" src=\"../image/sentmsgbutton.png\" title=\"View Sent Message\"></img></a></div>
