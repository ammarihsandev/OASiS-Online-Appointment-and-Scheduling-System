...
$query5="UPDATE message SET Note = 'read' WHERE Note ='unread' AND Student_ID = '".$Student_ID."' AND Lecturer_ID = '".$Lecturer_ID."' AND Sender = 'lecturer'";
...
$Lecturer_email = $row2['Lecturer_email'];
	if ($row['Note'] == "read")
	{
	$status = "&nbsp; &nbsp; &nbsp; <img src=\"http://iiumoasis.com/image/checkorg.png\" title=\"Read\" width=\"12\" height=\"12\" border=\"0\" ></img>";
	}
	else if ($row['Note'] == "unread")
	{
	$status = "&nbsp; &nbsp; &nbsp; <img src=\"http://iiumoasis.com/image/checkunread.png\" title=\"Unread\" width=\"12\" height=\"12\" border=\"0\" ></img>";
	}
...
$content="
<center><br/><table width=\"650\" style=\"background-color: #EFFBEF; border: 1px solid green;\"><tr><td><br/>&nbsp;<td><td></td></tr><tr>
	<td><center><table width=\"550\" style=\"background-color: #E1F9E1; border:1px dotted #6DDF6D\">".$username_string." 	 		
	<tr><td colspan=\"2\"><center>
	<table width=\"500\" border=\"0\">
	<tr><td width=\"415\"> <form action=\"sendmessage.php\" method=\"POST\">
	...
	</td><td></td></tr><tr><td><textarea cols=\"50\" rows=\"2\" name=\"Message_content\" placeholder=\"Write a message...\" required=\"required\"></textarea></td><td width=\"85\"><input type=\"image\" src=\"http://iiumoasis.com/image/send.png\" width=\"85\" height=\"47\"></img></td></tr></table></center></td></tr><tr><td colspan=\"2\"><hr bgcolor=\"#E1F9E1\"/></td></tr></table><br/><br/></center></td></tr>
	</table>";
	$title="Conversation with ".$lecturername;
