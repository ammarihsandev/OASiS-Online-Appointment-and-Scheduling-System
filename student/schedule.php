...
$dateo = substr($row['App_time'], 0, 10); 
 $username_array[] = "<tr><td><center>".$status."</center></td><td>".substr($name, 0, 20)."</td><td>".$dateo."</td><td>".substr($row['App_reason'], 0, 50)."</td><td><center>
	<a href=\"viewapp.php?App_ID=".$row['App_ID']."&Lecturer_ID=".$row['Lecturer_ID']."\"><img title=\"View Appointment\" width=\"22\" height=\"22\"  border=\"0\" src=\"../image/viewapp.png\"/></a>
	</center></td></tr>";
}
}
...
$content="
<div  align=\"right\"><a href=\"history.php\"><img  border=\"0\" src=\"../image/sentmsgbutton.png\" title=\"View Appointment History\"></img></a></div>
<center><br/><table width=\"650\" style=\"background-color: #EFFBEF; border: 1px solid green;\"><tr>
	<td></td><td><b>Lecturer Name</b></td><td><b>App. Time</b></td><td><b>Reason</b></td><td><center><b>Action</b></center></td></tr>".$username_string." 	 		
	</table>";
