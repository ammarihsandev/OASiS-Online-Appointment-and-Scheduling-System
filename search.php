...
if ($nw == 1)
	...
	$query3="SELECT * FROM lecturer WHERE Lecturer_fname LIKE '%".$lname."%' OR Lecturer_lname LIKE '%".$lname."%'" ;
		...
		echo "<tr><td width=\"134px\" valign=\"top\"><center><img width=\"80px\" height=\"100px\" src=\"http://".$row3[Lecturer_img]."\" title=\"".$row3[Lecturer_fname]."&nbsp;".$row3[Lecturer_lname]."\"</img><br>".$row3[Lecturer_fname]."&nbsp;".$row3[Lecturer_lname]."<br><small>".$row3[Lecturer_dep]."</small><br><a href=\"lecturer.php?Lecturer_ID=".$row3[Lecturer_ID]."\"><br><img src=\"image/vprofile.png\" title=\"View Profile\" alt=\"View Profile\"></img></a></center></td><td colspan=\"5\" width=\"465\">
