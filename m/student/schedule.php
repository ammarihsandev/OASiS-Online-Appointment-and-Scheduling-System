...
$dateneh = date("d M", strtotime($row['App_date']));
 ...
 $username_array[] = "<tr><td><center>".$status."</center></td><td>".substr($name, 0, 10)."..</td><td>".$dateneh.", ".$dateo."</td><td>".substr($row['App_reason'], 0, 10)."..</td><td><center>
...
<tr>
<div  align=\"right\"><a href=\"history.php\"><img  border=\"0\" src=\"https://www.iiumoasis.com/image/history.png\" title=\"View Appointment History\"></img></a>&nbsp;&nbsp;&nbsp;</div><br>
	<td></td><td><b>Lecturer Name</b></td><td><b>App. Time</b></td><td><b>Reason</b></td></tr>".$username_string." 	 		
	</table>";
