...
$Lecturer_email = $row2['Lecturer_email'];
	if ($row['Note'] == "read")
	{
	$status = "&nbsp; &nbsp; &nbsp; <img src=\"https://iiumoasis.com/image/checkorg.png\" title=\"Read\" width=\"12\" height=\"12\" border=\"0\" ></img>";
	}
	else if ($row['Note'] == "unread")
	{
	$status = "&nbsp; &nbsp; &nbsp; <img src=\"https://www.iiumoasis.com/image/checkunread.png\" title=\"Unread\" width=\"12\" height=\"12\" border=\"0\" ></img>";
	}
...
if ($row['Sender'] == "lecturer")
	{
	$image = "<img src=\"https://".$row2['Lecturer_img']."\" title=\"".$row2['Lecturer_fname']."\" width=\"73\" height=\"90\" border=\"0\" ></img>";
	$sendername = $row2['Lecturer_fname']."&nbsp;".$row2['Lecturer_lname'];
	}
	else if ($row['Sender'] == "student")
	{
	$image = "<img src=\"https://".$row3['Student_img']."\" title=\"".$row3['Student_fname']."\" width=\"73\" height=\"90\" border=\"0\" ></img>";
...
<center><br/><table width=\"98%\" style=\"background-color: #EFFBEF; border: 1px solid green;\"><tr><td><td><td></td></tr><tr>
	...
	</td><td></td></tr><tr><td><textarea cols=\"58\" rows=\"3\" name=\"Message_content\" placeholder=\"Write a message...\" required=\"required\"></textarea></td><td width=\"85\"><input type=\"image\" src=\"https://www.iiumoasis.com/image/send.png\" width=\"85\" height=\"47\"></img></td></tr></table></center></td></tr><tr><td colspan=\"2\"><hr bgcolor=\"#E1F9E1\"/></td></tr></table><br/></center></td></tr>
	</table>";
