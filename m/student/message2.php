...
$Student_ID = $_SESSION['myuser'];
	...
	if ($row['Note'] == "read")
	{
	$status = "<img src=\"https://www.iiumoasis.com/orange.png\" title=\"Read\" width=\"7\" height=\"7\" border=\"0\" ></img>";
	}
...
$dateo = substr($row['Message_time'], 0, 10); 
 $username_array[] = "<tr><td><center>".$status."</center></td><td>".substr($name, 0, 20)."</td><td><center>".$dateo."</center></td><td><center>
	<a href=\"viewsentmsg.php?Message_ID=".$row['Message_ID']."&Lecturer_ID=".$row['Lecturer_ID']."\"><img title=\"View Message\" width=\"24\" height=\"24\"  border=\"0\" src=\"https://www.iiumoasis.com/image/sentmsg.png\"/></a>	
	</center></td></tr>";
}
}
...
<tr>
<div  align=\"right\"><a href=\"message.php\"><img  border=\"0\" src=\"https://www.iiumoasis.com/image/inboxbtn.png\" title=\"View Sent Message\"></img></a>&nbsp;&nbsp;&nbsp;</div><br>
