...
<head>
	...
	<script src="js/jquery.mobile-1.4.5.min.js"></script>
      ...
      <title>Tutorial For Lecturer | IIUM OASiS</title>
...
<h2><img src="image/oasis.png" alt="IIUM OASIS"></h2>
		...
		<a href="login.php" class="jqm-search-link ui-btn ui-btn-icon-notext ui-corner-all ui-icon-user ui-nodisc-icon ui-alt-icon ui-btn-right">Login</a>
	</div>
...
?>
		...
		<div data-role="content" id="content">
			<ul data-role="listview" data-child-pages="true">
				<li data-role="list-divider"><h1><center>Tutorial For Lecturer</h1></center></li>
				<li>
					Login To the Website
					<ul>
						<li>1. Go to the IIUM OASiS website</li>
						<li>2. Enter your username (staff no)</li>
				...
				<li>
					...
					<ul>
						...
						<li>3. Write the information that you want to update</li>
				...
				<li>
					...
					<ul>
						<li>1. Log in to IIUM OASiS</li>
						<li>2. Click "my profile" menu</li>
						<li>3. Click "edit profile" tab</li>
						<li>4. Go to my picture and click the upload button</li>
						<li>5. Choose the picture from your computer</li>
						<li>6. Click on the update button</li>
					</ul>
				</li>
				<li>
					<h1>Set and Update available time</h1>
					<ul>
						<li>1. Log in to IIUM OASiS</li>
						<li>2. Click "my profile" menu</li>
						<li>3. Click "edit profile" tab</li>
						<li>4. Go to "available time" menu</li>
						<li>5. Click on the update button</li>
					</ul>
				</li>
				<li>
					<h1>View and Reply </h1>
					<ul>
						<li>1. Log in to IIUM OASiS</li>
						<li>2. Click "my message" menu to view the message</li>
						<li>3. Choose 'message' & click 'reply' button</li>
				...
				<li>
					...
					<ul>
						...
						<li>2. Click 'View Schedule' menu</li>
